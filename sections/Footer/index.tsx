      ...
      <div className="paddingX mx-auto">
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-8">
          <div className="lg:col-span-6">
            <Link href="/" className="block mb-8 sm:mb-16">
              <Logo variant='light' />
            </Link>
            <nav className="flex flex-wrap gap-x-4 gap-y-2 text-body md:text-menu font-medium max-w-lg">
              <Link href="/">Home</Link>
              <span>/</span>
          ...
          <div className="lg:col-span-3 space-y-6 md:space-y-10">
            <div className='h-fit'>
              ...
              <Link href="tel:+0280063344" className="text-titleMd font-medium hover:text-white">
                +02 8006 3344
              </Link>
            </div>
            <div>
              <h3 className="text-tag mb-2 font-medium">EMAIL</h3>
              <Link href="mailto:robert@cosmedixclinics.com.au" className="hover:text-white text-body font-normal">
